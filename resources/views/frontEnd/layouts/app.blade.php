...
<body class="blue-skin">
				...
				<div class="modal-content" id="registermodal">
					...
					<div class="modal-body">
						...
						<div class="login-form">
							<form>
								...
								<div class="form-group">
									<button type="button"
										class="btn btn-lg btn-main fw-medium full-width rounded-2">LogIn</button>
								</div>
						...
						<div class="text-center">
							<p class="mt-4">Have't Any Account? <a href="create-account.html"
									class="link fw-medium">Acreate An Account</a></p>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="{{asset('frontEnd')}}/js/typed.init.js"></script>
	<!-- ============================================================== -->
	<!-- This page plugins -->
	<!-- ============================================================== -->
