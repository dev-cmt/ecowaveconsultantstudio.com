                ...
                <div class="blog-detail">
                    <div class="news-block-two">
                        <div class="inner-box">
                            <div class="image-box">
                                @if($post->image_path)
                                    <figure class="image"><img src="{{ asset($post->image_path) }}" alt="{{ $post->title }}"></figure>
                                @endif
                            </div>
                        ...
                        <div class="comment-box {{ $comment->parent_id ? 'reply-comment' : '' }}">
                            <div class="comment">
                                <div class="author-thumb">
                                    <img src="{{ asset($comment->user->avatar ?? 'default-avatar.png') }}" alt="{{ $comment->user->name ?? 'User' }}">
                                </div>
                            ...
                            <article class="post">
                                <div class="post-thumb">
                                    <a href="{{ route('page.blogs-details', $recent->slug) }}">
                                        <img src="{{ asset($recent->image_path ?? 'default.png') }}" alt="{{ $recent->title }}">
                                    </a>
                                </div>
