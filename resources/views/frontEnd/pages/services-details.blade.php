            ...
            <div class="row clearfix">
                ...
                <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                    <aside class="sidebar services-sidebar">
                        ...
                        <!--Help Box-->
                        <div class="help-box" style="background-image:url(images/resource/brochure-bg.html)">
                            <div class="inner">
                        ...
                        <div class="inner-box">
                            <div class="image-box">
                                <div class="single-item-carousel owl-carousel owl-theme">
                                    <figure class="image"><img src="images/resource/service-detail.html" alt="" /></figure>
                                    <figure class="image"><img src="images/resource/service-detail.html" alt="" /></figure>
                                    <figure class="image"><img src="images/resource/service-detail.html" alt="" /></figure>
                                </div>
                            </div>
                            ...
                            <div class="text">
                                ...
                                <div class="two-column row">
                                    ...
                                    <div class="column col-lg-6 col-md-6 col-sm-12">
                                        <div class="image">
                                            <img src="images/resource/image-3.html" alt="" />
                                        </div>
                                    </div>
                                </div>
