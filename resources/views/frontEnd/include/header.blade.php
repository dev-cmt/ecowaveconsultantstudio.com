        ...
        <nav id="navigation" class="navigation navigation-landscape">
            <div class="nav-header">
                <a class="nav-brand text-logo" href="#">
                    ...
                    <h5 class="fs-3 fw-semibold ms-1 my-0">Resido</h5>
                </a>
                ...
                <div class="mobile_nav">
                    <ul>
                        ...
                        <!-- Appoinment -->
                        <li>
                            <a href="submit-property.html" class="text-main">
                                <span class="svg-icon svg-icon-2hx">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                <ul class="nav-menu">
                    ...
                    <li class="{{ Request::is('page/properties*') ? 'active' : '' }}"><a href="{{route('page.properties')}}">Properties</a></li>
                    <li class="{{ Request::is('page/about-us') ? 'active' : '' }}"><a href="{{route('page.about-us')}}">About Us</a></li>
                    <li class="{{ Request::is('page/contact*') ? 'active' : '' }}"><a href="{{route('page.contact')}}">Contact</a></li>
                </ul>
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    <li>
                        @auth
                            ...
                            <ul class="nav-dropdown nav-submenu">
                                ...
                                <li><a href="#">Bookmarked Listings</a></li>
                    ...
                    <li class="add-listing">
                        <a href="{{route('page.appoinment-from')}}" class="bg-main">
        ...
        <div class="tab-content" id="pills-tabContent">
                ...
                <div class="sidebar_featured_property">
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-1.jpg" class="img-fluid" alt="">
                        </div>
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-4.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="sides_list_property_detail">
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-7.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="sides_list_property_detail">
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-5.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="sides_list_property_detail">
                    ...
                    <div class="input-group">
                        <a href="compare-property.html" class="btn btn-light-main fw-medium full-width">View &
                            Compare</a>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade" id="pills-saved" role="tabpanel" aria-labelledby="pills-saved-tab"
                ...
                <div class="sidebar_featured_property">
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-2.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="sides_list_property_detail">
                            <h4><a href="single-property-1.html">Loss vengel New Apartment</a></h4>
                            <span class="text-muted-2"><i class="fa-solid fa-location-dot"></i>Sans
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-3.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="sides_list_property_detail">
                            <h4><a href="single-property-1.html">Montreal Quriqe Apartment</a></h4>
                            <span class="text-muted-2"><i class="fa-solid fa-location-dot"></i>Liverpool,
                    ...
                    <div class="sides_list_property p-2">
                        <div class="sides_list_property_thumb">
                            <img src="{{asset('frontEnd')}}/img/p-27.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="sides_list_property_detail">
                            <h4><a href="single-property-1.html">Montreal Quebec City</a></h4>
                            <span class="text-muted-2"><i class="fa-solid fa-location-dot"></i>Sreek View, New
                    ...
                    <div class="input-group">
                        <a href="#" class="btn btn-light-main fw-medium full-width">View & Compare</a>
                    </div>
                </div>
            </div>
        </div>
