    ...
    <div class="listing-content">
        ...
        <div class="listing-detail-wrapper-box">
            <div class="listing-detail-wrapper d-flex align-items-center justify-content-between">
                <div class="listing-short-detail">
                    ...
                    <h4 class="listing-name mb-0"><a href="{{route('page.property-details', $property->slug)}}">{{$property->title}}</a></h4>
        ...
        <div class="price-features-wrapper">
            <div class="list-fx-features d-flex align-items-center justify-content-between mt-3 mb-1">
                ...
                <div class="listing-card d-flex align-items-center">
                    <div class="square--25 text-muted-2 fs-sm circle gray-simple me-1"><i class="fas fa-vector-square fs-xs"></i></div><span class="text-muted-2 fs-sm">{{$property->dining_room}} Dining</span>
                </div>
                <div class="listing-card d-flex align-items-center">
                    <div class="square--25 text-muted-2 fs-sm circle gray-simple me-1"><i class="far fa-snowflake fs-xs"></i></div><span class="text-muted-2 fs-sm">{{$property->balcony}} Balcony</span>
                </div>
                {{-- <div class="listing-card d-flex align-items-center">
                    <div class="square--30 text-muted-2 fs-sm circle gray-simple me-1"><i class="far fa-object-ungroup fs-xs"></i></div><span class="text-muted-2 fs-sm">{{$property->area_size}} sq ft</span>
                </div> --}}
            </div>
        </div>
